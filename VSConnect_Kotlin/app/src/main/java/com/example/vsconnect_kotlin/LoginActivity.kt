...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEntrar.setOnClickListener {
            ...
            // o bloco abaixo foi desativado para dar lugar a função autenticar Usuario
                ...
                when(response.code()){
                    200 -> {
                       ...
                       val sharedPreferences = getSharedPreferences("idUsuario", Context.MODE_PRIVATE)
                        ...
                        //direcionandoo usuario para a tela lista de serviços
                    ...
                    403 -> { tratarFalhaNaAutenticacao(mensagemErro = "E-mail e/ou senha inválidos") }
                    else -> { tratarFalhaNaAutenticacao(mensagemErro = "Falha ao logar!") }
                }
            }
